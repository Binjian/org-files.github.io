...
#+REVEAL_TITLE_SLIDE: ./templates/title_git_nutshell.html
...
#+REVEAL_HTML: <div class="gridded_frame_with_columns">
     #+REVEAL_HTML: <div class="one_of_2_columns">
        #+ATTR_HTML: :alt  :title Sutskever 2015 :width 400pix  :align center
            ...
            #+begin_src mermaid :file ./img/git_in_a_nutshell/loeliger.png
            flowchart TD
               G --> D
               H --> D
               I --> F
            ...
            [[file:./img/git_in_a_nutshell/loeliger.png]]
...
#+REVEAL_HTML: <div class="gridded_frame_with_columns">
     #+REVEAL_HTML: <div class="one_of_2_columns">
        #+ATTR_HTML: :alt  :title loeliger  :width 400pix  :align center
            #+caption[dataflow]: 多分支的版本历史
            #+results: fig. loeliger diagram
            [[file:./img/git_in_a_nutshell/loeliger.png]]
